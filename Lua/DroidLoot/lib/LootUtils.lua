...
local function getRule(item)
    ...
    local wornRangedDmg = mq.TLO.Me.Inventory(11).Damage() or 0
    local wornPrimaryDelay = mq.TLO.Me.Inventory(13).ItemDelay() or 0
    local wornSecondaryDelay = mq.TLO.Me.Inventory(14).ItemDelay() or 0
    local wornRangedDelay = mq.TLO.Me.Inventory(11).ItemDelay() or 0
    ...
    local itemAugSlot1 = item.AugSlot1() or 0
    local itemAugSlot2 = item.AugSlot2() or 0
    local itemAugSlot3 = item.AugSlot3() or 0
    local itemAugSlot4 = item.AugSlot4() or 0
    local itemAugSlot5 = item.AugSlot5() or 0
    local itemAugSlot6 = item.AugSlot6() or 0
