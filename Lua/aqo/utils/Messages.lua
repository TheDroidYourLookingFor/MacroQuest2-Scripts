...
function messages.Normal(consoleMessage, ...)
    local timestamp = os.date("[%H:%M:%S]")
    messages.CONSOLEMETHOD(false, timestamp .. "[" .. messages.script_ShortName .. "]" .. Colors.w .. consoleMessage, ...)
end

function messages.Info(consoleMessage, ...)
    local timestamp = os.date("[%H:%M:%S]")
    messages.CONSOLEMETHOD(false, timestamp .. "[" .. messages.script_ShortName .. "]" .. Colors.p .. '[INFO] ' .. Colors.w .. consoleMessage, ...)
end

function messages.Warn(consoleMessage, ...)
    local timestamp = os.date("[%H:%M:%S]")
    messages.CONSOLEMETHOD(false, timestamp .. "[" .. messages.script_ShortName .. "]" .. Colors.y .. '[WARN] ' .. Colors.w .. consoleMessage, ...)
end

function messages.Debug(consoleMessage, ...)
    local timestamp = os.date("[%H:%M:%S]")
    messages.CONSOLEMETHOD(true, timestamp .. Colors.r .. '[DEBUG] ' .. Colors.w .. consoleMessage, ...)
end

function messages.Error(consoleMessage, ...)
    local timestamp = os.date("[%H:%M:%S]")
    messages.CONSOLEMETHOD(false, timestamp .. "[" .. messages.script_ShortName .. "]" .. Colors.Y .. '[ERROR] ' .. Colors.w .. consoleMessage, ...)
end

function messages.Fatal(consoleMessage, ...)
    local timestamp = os.date("[%H:%M:%S]")
    messages.CONSOLEMETHOD(true, timestamp .. Colors.R .. '[FATAL] ' .. Colors.w .. consoleMessage, ...)
end

function messages.Trace(consoleMessage, ...)
    local timestamp = os.date("[%H:%M:%S]")
    messages.CONSOLEMETHOD(false, timestamp .. "[" .. messages.script_ShortName .. "]" .. Colors.P .. '[TRACE] ' .. Colors.w .. consoleMessage, ...)
end
