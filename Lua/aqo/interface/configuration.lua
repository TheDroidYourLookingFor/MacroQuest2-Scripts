...
local config = {
    ...
    INTERRUPTFULLHP = {
        value = true,
        tip = 'Toggle whether to interrupt heals if the target is already full HP',
        classes = constants.healClasses,
        label = 'Interrupt Full HP',
        type = 'checkbox',
        tlo = 'InterruptFullHP',
        tlotype = 'bool',
    },
    ...
    ANNOUNCEDEATHS = {
        value = false,
        tip = 'Toggle whether to announce tank deaths into raid',
    ...
    USEWARP = {
        value = false,
        tip = 'Toggle whether character should use warp or navigation.',
        label = 'Use Warp',
        type = 'checkbox',
        tlo = 'UseWarp',
        tlotype = 'bool',
    ...
    USEWARPININSTANCE = {
        value = false,
        tip = 'Toggle whether character should use warp only in instances.',
        label = 'Instance Warp Only',
        type = 'checkbox',
    ...
    OFFTANK = {
        value = false,
        tip = 'Toggle picking up mobs on xtarget which main tank isn\'t fighting',
        label = 'Off Tank',
        type = 'checkbox',
        emu = true,
        tlo = 'OffTank',
...
local configByCategory = {
    Assist={'MODE','ASSIST','AUTOASSISTAT','ASSISTNAMES','SWITCHWITHMA','STICKCOMMAND','RESISTSTOPCOUNT','NUKEMANAMIN','DOTMANAMIN','USEWARP','USEWARPININSTANCE'},
