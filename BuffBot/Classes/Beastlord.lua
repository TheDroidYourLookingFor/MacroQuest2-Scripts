...
local beastloard_version = '1.0.0'
local beastloard = {}
...
function beastloard.MemorizeSpells()
    if beastloard.beastloard_settings.buffs_1_45_Enabled then
        Casting.MemSpell(beastloard.beastloard_settings.hpBuffs[beastloard.beastloard_settings.hp_buff_1_45_current_idx], 1)
        Casting.MemSpell(beastloard.beastloard_settings.attackBuffs[beastloard.beastloard_settings.attack_buff_1_45_current_idx], 2)
        Casting.MemSpell(beastloard.beastloard_settings.manaBuffs[beastloard.beastloard_settings.mana_buff_1_45_current_idx], 1)
        Casting.MemSpell(beastloard.beastloard_settings.attackv2Buffs[beastloard.beastloard_settings.attackv2_buff_1_45_current_idx], 2)
    end

    if beastloard.beastloard_settings.buffs_46_60_Enabled then
        Casting.MemSpell(beastloard.beastloard_settings.hpBuffs[beastloard.beastloard_settings.hp_buff_46_60_current_idx], 1)
        Casting.MemSpell(beastloard.beastloard_settings.attackBuffs[beastloard.beastloard_settings.attack_buff_46_60_current_idx], 2)
        Casting.MemSpell(beastloard.beastloard_settings.manaBuffs[beastloard.beastloard_settings.mana_buff_46_60_current_idx], 1)
        Casting.MemSpell(beastloard.beastloard_settings.attackv2Buffs[beastloard.beastloard_settings.attackv2_buff_46_60_current_idx], 2)
    end

    if beastloard.beastloard_settings.buffs_61_70_Enabled then
        Casting.MemSpell(beastloard.beastloard_settings.hpBuffs[beastloard.beastloard_settings.hp_buff_61_70_current_idx], 1)
        Casting.MemSpell(beastloard.beastloard_settings.attackBuffs[beastloard.beastloard_settings.attack_buff_61_70_current_idx], 2)
        Casting.MemSpell(beastloard.beastloard_settings.manaBuffs[beastloard.beastloard_settings.mana_buff_61_70_current_idx], 1)
        Casting.MemSpell(beastloard.beastloard_settings.attackv2Buffs[beastloard.beastloard_settings.attackv2_buff_61_70_current_idx], 2)
    end

    if beastloard.beastloard_settings.buffs_71_84_Enabled then
        Casting.MemSpell(beastloard.beastloard_settings.hpBuffs[beastloard.beastloard_settings.hp_buff_71_84_current_idx], 1)
        Casting.MemSpell(beastloard.beastloard_settings.attackBuffs[beastloard.beastloard_settings.attack_buff_71_84_current_idx], 2)
        Casting.MemSpell(beastloard.beastloard_settings.manaBuffs[beastloard.beastloard_settings.mana_buff_71_84_current_idx], 1)
        Casting.MemSpell(beastloard.beastloard_settings.attackv2Buffs[beastloard.beastloard_settings.attackv2_buff_71_84_current_idx], 2)
    end

    if beastloard.beastloard_settings.buffs_85_plus_Enabled then
        Casting.MemSpell(beastloard.beastloard_settings.hpBuffs[beastloard.beastloard_settings.hp_buff_85_plus_current_idx], 1)
        Casting.MemSpell(beastloard.beastloard_settings.attackBuffs[beastloard.beastloard_settings.attack_buff_85_plus_current_idx], 2)
        Casting.MemSpell(beastloard.beastloard_settings.manaBuffs[beastloard.beastloard_settings.mana_buff_85_plus_current_idx], 1)
        Casting.MemSpell(beastloard.beastloard_settings.attackv2Buffs[beastloard.beastloard_settings.attackv2_buff_85_plus_current_idx], 2)
    end
end

function beastloard.Buff()
    if mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() <= 45 then
        Casting.CastBuff(beastloard.beastloard_settings.hpBuffs[beastloard.beastloard_settings.hp_buff_1_45_current_idx], 'gem1')
        Casting.CastBuff(beastloard.beastloard_settings.attackBuffs[beastloard.beastloard_settings.attack_buff_1_45_current_idx], 'gem2')
        Casting.CastBuff(beastloard.beastloard_settings.manaBuffs[beastloard.beastloard_settings.mana_buff_1_45_current_idx], 'gem3')
        Casting.CastBuff(beastloard.beastloard_settings.attackv2Buffs[beastloard.beastloard_settings.attackv2_buff_1_45_current_idx], 'gem4')
    end
    if mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() >= 46 and mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() <= 60 then
        Casting.CastBuff(beastloard.beastloard_settings.hpBuffs[beastloard.beastloard_settings.hp_buff_46_60_current_idx], 'gem5')
        Casting.CastBuff(beastloard.beastloard_settings.attackBuffs[beastloard.beastloard_settings.attack_buff_46_60_current_idx], 'gem6')
        Casting.CastBuff(beastloard.beastloard_settings.manaBuffs[beastloard.beastloard_settings.mana_buff_46_60_current_idx], 'gem7')
        Casting.CastBuff(beastloard.beastloard_settings.attackv2Buffs[beastloard.beastloard_settings.attackv2_buff_46_60_current_idx], 'gem8')
    end
    if mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() >= 61 and mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() <= 70 then
        Casting.CastBuff(beastloard.beastloard_settings.hpBuffs[beastloard.beastloard_settings.hp_buff_61_70_current_idx], 'gem9')
        Casting.CastBuff(beastloard.beastloard_settings.attackBuffs[beastloard.beastloard_settings.attack_buff_61_70_current_idx], 'gem10')
        Casting.CastBuff(beastloard.beastloard_settings.manaBuffs[beastloard.beastloard_settings.mana_buff_61_70_current_idx], 'gem11')
        Casting.CastBuff(beastloard.beastloard_settings.attackv2Buffs[beastloard.beastloard_settings.attackv2_buff_61_70_current_idx], 'gem12')
    end
    if mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() >= 71 and mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() <= 84 then
        Casting.CastBuff(beastloard.beastloard_settings.hpBuffs[beastloard.beastloard_settings.hp_buff_71_84_current_idx], 'gem10')
        Casting.CastBuff(beastloard.beastloard_settings.attackBuffs[beastloard.beastloard_settings.attack_buff_71_84_current_idx], 'gem11')
        Casting.CastBuff(beastloard.beastloard_settings.manaBuffs[beastloard.beastloard_settings.mana_buff_71_84_current_idx], 'gem3')
        Casting.CastBuff(beastloard.beastloard_settings.attackv2Buffs[beastloard.beastloard_settings.attackv2_buff_71_84_current_idx], 'gem4')
    end
    if mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() >= 85 then
        Casting.CastBuff(beastloard.beastloard_settings.hpBuffs[beastloard.beastloard_settings.hp_buff_85_plus_current_idx], 'gem1')
        Casting.CastBuff(beastloard.beastloard_settings.attackBuffs[beastloard.beastloard_settings.attack_buff_85_plus_current_idx], 'gem2')
        Casting.CastBuff(beastloard.beastloard_settings.manaBuffs[beastloard.beastloard_settings.mana_buff_85_plus_current_idx], 'gem3')
        Casting.CastBuff(beastloard.beastloard_settings.attackv2Buffs[beastloard.beastloard_settings.attackv2_buff_85_plus_current_idx], 'gem4')
    end
end
...
function beastloard.ShowClassBuffBotGUI()
    ...
    -- Help
    --
    if imgui.CollapsingHeader("Beastloard v" .. beastloard_version) then
        ...
        if ImGui.TreeNode('1-45 Spells:') then
            ...
            beastloard.beastloard_settings.hp_buff_1_45_current_idx = GUI.CreateBuffBox:draw("1-45 HP", beastloard.hp_Buffs,
            ...
            beastloard.beastloard_settings.mana_buff_1_45_current_idx = GUI.CreateBuffBox:draw("1-45 MANA", beastloard.mana_Buffs,
        ...
        if ImGui.TreeNode('46-60 Spells:') then
            ...
            beastloard.beastloard_settings.mana_buff_46_60_current_idx = GUI.CreateBuffBox:draw("46-60 MANA", beastloard.mana_Buffs,
        ...
        if ImGui.TreeNode('61-70 Spells:') then
            ...
            beastloard.beastloard_settings.mana_buff_61_70_current_idx = GUI.CreateBuffBox:draw("61-70 MANA", beastloard.mana_Buffs,
        ...
        if ImGui.TreeNode('71-84 Spells:') then
            ...
            beastloard.beastloard_settings.mana_buff_71_84_current_idx = GUI.CreateBuffBox:draw("71-84 MANA", beastloard.mana_Buffs,
        ...
        if ImGui.TreeNode('85+ Spells:') then
            ...
            beastloard.beastloard_settings.mana_buff_85_plus_current_idx = GUI.CreateBuffBox:draw("85+ MANA", beastloard.mana_Buffs,
