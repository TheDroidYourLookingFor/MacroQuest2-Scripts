...
function enchanter.MemorizeSpells()
    if enchanter.enchanter_settings.buffs_1_45_Enabled then
        Casting.MemSpell(enchanter.enchanter_settings.hasteBuffs[enchanter.enchanter_settings.haste_buff_1_45_current_idx], 1)
        Casting.MemSpell(enchanter.enchanter_settings.clarityBuffs[enchanter.enchanter_settings.clarity_buff_1_45_current_idx], 2)
    end

    if enchanter.enchanter_settings.buffs_46_60_Enabled then
        Casting.MemSpell(enchanter.enchanter_settings.hasteBuffs[enchanter.enchanter_settings.haste_buff_46_60_current_idx], 1)
        Casting.MemSpell(enchanter.enchanter_settings.clarityBuffs[enchanter.enchanter_settings.clarity_buff_46_60_current_idx], 2)
    end

    if enchanter.enchanter_settings.buffs_61_70_Enabled then
        Casting.MemSpell(enchanter.enchanter_settings.hasteBuffs[enchanter.enchanter_settings.haste_buff_61_70_current_idx], 1)
        Casting.MemSpell(enchanter.enchanter_settings.clarityBuffs[enchanter.enchanter_settings.clarity_buff_61_70_current_idx], 2)
    end

    if enchanter.enchanter_settings.buffs_71_84_Enabled then
        Casting.MemSpell(enchanter.enchanter_settings.hasteBuffs[enchanter.enchanter_settings.haste_buff_71_84_current_idx], 1)
        Casting.MemSpell(enchanter.enchanter_settings.clarityBuffs[enchanter.enchanter_settings.clarity_buff_71_84_current_idx], 2)
    end

    if enchanter.enchanter_settings.buffs_85_plus_Enabled then
        Casting.MemSpell(enchanter.enchanter_settings.hasteBuffs[enchanter.enchanter_settings.haste_buff_85_plus_current_idx], 1)
        Casting.MemSpell(enchanter.enchanter_settings.clarityBuffs[enchanter.enchanter_settings.clarity_buff_85_plus_current_idx], 2)
    end
end

function enchanter.Buff()
    if mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() <= 45 then
        Casting.CastBuff(enchanter.enchanter_settings.hasteBuffs[enchanter.enchanter_settings.haste_buff_1_45_current_idx], 'gem1')
        Casting.CastBuff(enchanter.enchanter_settings.clarityBuffs[enchanter.enchanter_settings.clarity_buff_1_45_current_idx], 'gem2')
    end
    if mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() >= 46 and mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() <= 60 then
        Casting.CastBuff(enchanter.enchanter_settings.hasteBuffs[enchanter.enchanter_settings.haste_buff_46_60_current_idx], 'gem4')
        Casting.CastBuff(enchanter.enchanter_settings.clarityBuffs[enchanter.enchanter_settings.clarity_buff_46_60_current_idx], 'gem5')
    end
    if mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() >= 61 and mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() <= 70 then
        Casting.CastBuff(enchanter.enchanter_settings.hasteBuffs[enchanter.enchanter_settings.haste_buff_61_70_current_idx], 'gem7')
        Casting.CastBuff(enchanter.enchanter_settings.clarityBuffs[enchanter.enchanter_settings.clarity_buff_61_70_current_idx], 'gem8')
    end
    if mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() >= 71 and mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() <= 84 then
        Casting.CastBuff(enchanter.enchanter_settings.hasteBuffs[enchanter.enchanter_settings.haste_buff_71_84_current_idx], 'gem10')
        Casting.CastBuff(enchanter.enchanter_settings.clarityBuffs[enchanter.enchanter_settings.clarity_buff_71_84_current_idx], 'gem11')
    end
    if mq.TLO.Spawn('ID ' .. mq.TLO.Target.ID()).Level() >= 85 then
        Casting.CastBuff(enchanter.enchanter_settings.hasteBuffs[enchanter.enchanter_settings.haste_buff_85_plus_current_idx], 'gem1')
        Casting.CastBuff(enchanter.enchanter_settings.clarityBuffs[enchanter.enchanter_settings.clarity_buff_85_plus_current_idx], 'gem2')
    end
end
...
function enchanter.ShowClassBuffBotGUI()
    ...
    -- Help
    --
    if imgui.CollapsingHeader("Enchanter v" .. enchanter_version) then
        ...
        if ImGui.TreeNode('1-45 Spells:') then
            ...
            enchanter.enchanter_settings.haste_buff_1_45_current_idx = GUI.CreateBuffBox:draw("1-45 HASTE", enchanter.haste_Buffs,
